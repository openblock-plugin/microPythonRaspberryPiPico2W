        ...
        return [
            {
                ...
                blocks: [
                    ...
                    },
                    {
                        opcode: 'setPwmOutput',
                        text: formatMessage({
                            id: 'microPythonRaspberryPiPico2W.pins.setPwmOutput',
                    ...
                    '---',
                    {
                        ...
                        text: formatMessage({
                            id: 'microPythonRaspberryPiPico2W.pins.setServoOutput',
                ...
                blocks: [
                    {
                        opcode: 'serialBegin',
                        text: formatMessage({
                            id: 'microPythonRaspberryPiPico2W.serial.serialBegin',
