...
const DIVECE_OPT = {
    ...
    firmware: 'microPython-standard-raspberryPiPico2W.uf2'
};
...
class MicroPythonRaspberryPiPico2W extends CommonPeripheral {
    constructor (runtime, deviceId) {
        super(runtime, deviceId, PNPID_LIST, SERIAL_CONFIG, DIVECE_OPT);
    }
}

class OpenBlockMicroPythonRaspberryPiPico2WDevice {
    get DEVICE_ID () {
        return 'microPythonRaspberryPiPico2W';
    }
    ...
    get MODE_MENU () {
        return [
            {
                text: formatMessage({
                    id: 'microPythonRaspberryPiPico2W.modeMenu.input',
                    default: 'input',
            ...
            {
                text: formatMessage({
                    id: 'microPythonRaspberryPiPico2W.modeMenu.output',
                    default: 'output',
            ...
            {
                text: formatMessage({
                    id: 'microPythonRaspberryPiPico2W.modeMenu.inputPullup',
            ...
            {
                text: formatMessage({
                    id: 'microPythonRaspberryPiPico2W.modeMenu.inputPulldown',
    ...
    get LEVEL_MENU () {
        return [
            {
                text: formatMessage({
                    id: 'microPythonRaspberryPiPico2W.levelMenu.high',
                    default: 'high',
            ...
            {
                text: formatMessage({
                    id: 'microPythonRaspberryPiPico2W.levelMenu.low',
                    default: 'low',
    ...
    get INTERRUP_MODE_MENU () {
        return [
            {
                text: formatMessage({
                    id: 'microPythonRaspberryPiPico2W.InterrupModeMenu.risingEdge',
                    default: 'rising edge',
            ...
            {
                text: formatMessage({
                    id: 'microPythonRaspberryPiPico2W.InterrupModeMenu.fallingEdge',
            ...
            {
                text: formatMessage({
                    id: 'microPythonRaspberryPiPico2W.InterrupModeMenu.changeEdge',
                    default: 'change edge',
    ...
    get EOL_MENU () {
        return [
            {
                text: formatMessage({
                    id: 'microPythonRaspberryPiPico2W.eolMenu.warp',
                    default: 'warp',
            ...
            {
                text: formatMessage({
                    id: 'microPythonRaspberryPiPico2W.eolMenu.noWarp',
                    default: 'no-warp',
    ...
    constructor (runtime) {
        ...
        this._peripheral = new MicroPythonRaspberryPiPico2W(this.runtime, this.DEVICE_ID);
    }
        ...
        return [
            {
                id: 'pin',
                name: formatMessage({
                    id: 'microPythonRaspberryPiPico2W.category.pins',
                    default: 'Pins',
                ...
                blocks: [
                    {
                        opcode: 'setPinMode',
                        text: formatMessage({
                            id: 'microPythonRaspberryPiPico2W.pins.setPinMode',
                    ...
                    },
                    {
                        ...
                        text: formatMessage({
                            id: 'microPythonRaspberryPiPico2W.pins.setDigitalOutput',
                    ...
                    },
                    {
                        ...
                        text: formatMessage({
                            id: 'microPythonRaspberryPiPico2W.pins.setPwmOutputU16',
                    ...
                    '---',
                    {
                        ...
                        text: formatMessage({
                            id: 'microPythonRaspberryPiPico2W.pins.readDigitalPin',
                    ...
                    },
                    {
                        ...
                        text: formatMessage({
                            id: 'microPythonRaspberryPiPico2W.pins.readAnalogPin',
                    ...
                    '---',
                    {
                        ...
                        text: formatMessage({
                            id: 'microPythonRaspberryPiPico2W.pins.setServoOutputU16',
                    ...
                    '---',
                    {
                        ...
                        text: formatMessage({
                            id: 'microPythonRaspberryPiPico2W.pins.attachInterrupt',
            ...
            },
            {
                id: 'serial',
                name: formatMessage({
                    id: 'microPythonRaspberryPiPico2W.category.serial',
                    default: 'Serial',
                ...
                blocks: [
                    {
                        opcode: 'raspberryPiPico2WSerialBegin',
                        text: formatMessage({
                            id: 'microPythonRaspberryPiPico2W.serial.raspberryPiPicoSerialBegin',
                    ...
                    },
                    {
                        ...
                        text: formatMessage({
                            id: 'microPythonRaspberryPiPico2W.serial.multiSerialPrint',
                    ...
                    },
                    {
                        ...
                        text: formatMessage({
                            id: 'microPythonRaspberryPiPico2W.serial.multiSerialReadALine',
            ...
            },
            {
                id: 'console',
                name: formatMessage({
                    id: 'microPythonRaspberryPiPico2W.category.console',
                    default: 'Console',
                ...
                blocks: [
                    {
                        opcode: 'consolePrint',
                        text: formatMessage({
                            id: 'microPythonRaspberryPiPico2W.console.consolePrint',
                    ...
                    },
                    {
                        opcode: 'consoleInput',
                        text: formatMessage({
                            id: 'microPythonRaspberryPiPico2W.console.consoleInput',
...
export default OpenBlockMicroPythonRaspberryPiPico2WDevice;
